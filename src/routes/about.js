...
function About(){
    return (
        ...
        <div className="masthead js-masthead-fixed" data-context="page.masthead" data-hover-hint="mastheadOptions" data-hover-hint-placement="top-start">
                          ...
                          <div className="project-module module text project-module-text align- js-project-module e2e-site-project-module-text" style={{paddingTop: '60px', paddingBottom: '60px', width: '80%', maxWidth: '900px', float: 'center', clear: 'both'}}>
                            <div className="rich-text js-text-editable module-text">
                              ...
                              <div style={{lineHeight: '28px', textAlign: 'left'}} className="texteditor-inline-lineheight">My skills
                                cover a range of disciplines, from print to digital, concepts to finish art, and it's this
                                flexibility that is my best strength – the ability to approach every project with an open
                                mindset, and tailor a fitting response to the brief. &nbsp;</div>
                              <div style={{lineHeight: '28px', textAlign: 'left'}} className="texteditor-inline-lineheight">Being a
                                Jack of all trades&nbsp;doesn't stop me from being an expert in some, and am particularly
                                confident in my ability to illustrate, take a photo, or retouching. I even dabble a little in
                                audio and video production and animation. I love being hands-on in the design process, so if I
                                have the opportunity to do it myself, and learn some new tricks along the way, then I will
                                relish the opportunity to do so.</div>
                            </div>
                          </div>
                              ...
                              <div className="tree-child-wrapper" style={{flex: 121}}>
                                <div className="project-module module image project-module-image js-js-project-module" style={{paddingTop: '0px', paddingBottom: '20px', width: '96%', float: 'left', clear: 'both'}}>
                                  <div className="js-lightbox lightbox-link" data-src="https://cdn.myportfolio.com/73096b60-5650-4a8d-9d7c-f05a47b7ccfe/d6b9a1b8-3204-421a-bafc-fdd23ae2c833.jpg?h=7cf09619eea946f6062f71a1932ab2ac">
                                    <img className="js-lazy e2e-site-project-module-image image-loaded" src="./Jack Cole - About_files/d6b9a1b8-3204-421a-bafc-fdd23ae2c833_rw_1200.jpg" width={1200} srcSet="https://cdn.myportfolio.com/73096b60-5650-4a8d-9d7c-f05a47b7ccfe/d6b9a1b8-3204-421a-bafc-fdd23ae2c833_rw_600.jpg?h=cf601afa9b4a0426aaf6868703ac6cef 600w,https://cdn.myportfolio.com/73096b60-5650-4a8d-9d7c-f05a47b7ccfe/d6b9a1b8-3204-421a-bafc-fdd23ae2c833_rw_1200.jpg?h=2d7fda4c554b6821aeafc98d561265a7 1200w," sizes="(max-width: 1200px) 100vw, 1200px" />
                                  </div>
                                    ...
                                    <div style={{lineHeight: '28px', textAlign: 'left'}} className="texteditor-inline-lineheight">
                                      ...
                                      <div>
                                        <div>I'm slightly obsessed by drums, and really the whole design 'thing' is just a
                                          front until the new dad rock band I've joined explodes.&nbsp;</div>
